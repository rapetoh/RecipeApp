...
export default function SignUpPage() {
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    console.log('🔐 Signup handleSubmit called', { name: name.substring(0, 3) + '...', email: email.substring(0, 3) + '...', hasPassword: !!password });
  ...
  }, [name, email, password, callbackUrl, navigate, isInWebView]);
    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-orange-50 to-yellow-50 p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Join RecipeApp today!</p>
        </div>
